...
import numpy as np
from source.Experiment import Experiment, Recorder
from source.utils import *
from source.constants import CONVERGENCE_EPSILON, IMAGE_DPI
...
class Plotter:
    ...
    def isconverging(self, data):
        ...
        return abs(min(data_at_inf)-max(data_at_inf)) <= CONVERGENCE_EPSILON
    ...
    def plot(self, experiment: "Experiment", title, scale="symlog", percentage=1.0):
        ...
        fig.savefig(filename(self.path, title), dpi=IMAGE_DPI)
